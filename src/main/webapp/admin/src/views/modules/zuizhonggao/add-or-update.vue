<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="论文标题" prop="lunwenbiaoti">
          <el-input v-model="ruleForm.lunwenbiaoti" 
              placeholder="论文标题" clearable  :readonly="ro.lunwenbiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="论文标题" prop="lunwenbiaoti">
              <el-input v-model="ruleForm.lunwenbiaoti" 
                placeholder="论文标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="概要" prop="gaiyao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="概要"
                  v-model="ruleForm.gaiyao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gaiyao" label="概要" prop="gaiyao">
                    <span>{{ruleForm.gaiyao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bianhao = true;
          ...
          if(o=='lunwenbiaoti'){
            this.ruleForm.lunwenbiaoti = obj[o];
	    this.ro.lunwenbiaoti = true;
            continue;
          }
          if(o=='gaiyao'){
            this.ruleForm.gaiyao = obj[o];
	    this.ro.gaiyao = true;
            continue;
          }
          if(o=='dianzidang'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zuizhonggao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zuizhonggaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
